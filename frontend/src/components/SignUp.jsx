    ...
    return (
         ...
         <DialogContent>
             ...
             <Grid  container   justifyContent="space-between" alignItems="center">
                 <Grid item >
                      <TextField onChange={e => companyId.onChange(e)} onBlur={e => companyId.onBlur(e)} autoFocus margin="dense" id="companyId" label="Company Id" type="string" fullWidth variant="filled" />
                 </Grid>
                 <h3>or</h3>
                 <Grid item >
                      <TextField onChange={e => CreateCompany.onChange(e)} onBlur={e => CreateCompany.onBlur(e)} autoFocus margin="dense" id="CreateCompany" label="Create Company" type="String" fullWidth variant="filled" />
                 </Grid>
             </Grid>
            </DialogContent>
    );
